...
CREATE TABLE Pool (
   ...
   NextPoolId INTEGER UNSIGNED DEFAULT 0 REFERENCES Pool(PoolId),
...
CREATE TABLE BaseFiles (
   ...
   BaseJobId INTEGER UNSIGNED NOT NULL REFERENCES Job(JobId),
...
CREATE TABLE Quota (
   ClientId INTEGER UNSIGNED DEFAULT 0 REFERENCES Client,
