...
class TestBareosFd(unittest.TestCase):
    ...
    def test_RestorePacket(self):
        ...
        self.assertEqual(
            'RestorePacket(stream=0, data_stream=0, type=0, file_index=0, linkFI=0, uid=0, statp="<NULL>", attrEx="<NULL>", ofname="", olname="", where="", RegexWhere="", replace=0, create_status=0)',
    ...
    def test_IoPacket(self):
        ...
        self.assertEqual(
            'IoPacket(func=0, count=0, flags=0, mode=0000, buf="", fname="", status=0, io_errno=0, lerror=0, whence=0, offset=0, win32=0)',
            str(test_IoPacket),
        )
